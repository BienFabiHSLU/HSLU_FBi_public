...
for i in range (1,6):
    ...
    aboveX=leicaPosAboveStart["field.point.x"].mean()
    aboveY=leicaPosAboveStart["field.point.y"].mean()
    aboveZ=leicaPosAboveStart["field.point.z"].mean()
    aboveM=[aboveX,aboveY, aboveZ]
    #print(aboveM)
    
    ##Einlesen: Prisma Position unten
    
    bottomX=leicaPosBottomStart["field.point.x"].mean()
    bottomY=leicaPosBottomStart["field.point.y"].mean()
    bottomZ=leicaPosBottomStart["field.point.z"].mean()
    ...
    aboveX=leicaPosAboveEnd["field.point.x"].mean()
    aboveY=leicaPosAboveEnd["field.point.y"].mean()
    aboveZ=leicaPosAboveEnd["field.point.z"].mean()
    aboveM=[aboveX,aboveY, aboveZ]
    #print(aboveM)
    
    ##Einlesen: Prisma Position unten
    
    bottomX=leicaPosBottomEnd["field.point.x"].mean()
    bottomY=leicaPosBottomEnd["field.point.y"].mean()
    bottomZ=leicaPosBottomEnd["field.point.z"].mean()
    bottomM=[bottomX, bottomY, bottomZ]
    #print(bottomM)
