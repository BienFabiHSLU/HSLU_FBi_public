...
csvfile = open('PAIND_Kalib.csv', 'w', newline='')
...
for i in range (1,6):
	...
	for f in glob(baseFolderPath+"/IMU_aufgelegt"+str(i)+"_*bag.txt"):
	    ...
	    label= "IMU_aufgelegt_RollX"+str(i)
	    ...
	    label= "IMU_aufgelegtPitchY"+str(i)
